...
const Player = ({currentSong, audioRef, isPlaying, 
  songs, setIsPlaying, setCurrentSong,
   setSongInfo, songInfo, setSongs }) => {
  ...
  return (
    <div className='player'>
      ...
      <div className='play-control' >
        ...
        <FontAwesomeIcon onClick={playSoundHandler}
